package com.huwdunnit.spaceattack.utils.debug;
...
/**
 * Config for the DebugCameraController class.
 *
 * @author Huw
 */
public class DebugCameraConfig {
    ...
    // Where the config file can be found
    ...
    private void init() {
        ...
        if (fileHandle.exists()) {
            ...
            log.info("Unable to find config file at " + FILE_PATH + ", using defaults");
            setupDefaults();
        }
    }
